...
// check the extension
$extensions = array( 'jpg', 'jpeg', 'gif', 'png', 'txt', 'rtf', 'pdf', 'doc', 'xml');

// does it contain .php?
if( strpos( strtolower( $fileName ), '.php' ) !== false || strtolower( substr( $fileName, -4 ) ) == '.php' )
    die();
...
if (!$chunks || $chunk == $chunks - 1) {
    ...
    $attach_id = wp_insert_attachment(array(
    	...
    	'post_status' 		=> 'inherit'
	), $filePath, $advertiser->profile()->id());
	...
	$preview = wp_get_attachment_image_src($attach_id, 'venue-thumbnail');
