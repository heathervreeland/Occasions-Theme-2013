          ...
          <ol>
            ...
            foreach ($state->cities as $city): 
              if ( $tax_venue_type ) {
                ...
                echo '<li><a href="' . flo_get_region_venue_permalink($city, $tax_venue_type->slug, "venues") . '" class="title">' . $city->name . '</a></li>';

              } else {
              
                // otherwise we are looking at a service taxonomy search
                echo '<li><a href="' . flo_get_region_venue_permalink($city, $tax_service->slug, "services") . '" class="title">' . $city->name . '</a></li>';
